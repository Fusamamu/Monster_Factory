Shader "MUGCUP Custom Shaders/Unlit/Master Shader"
{
    Properties
    {
        ...
        [Space(10)]
        _GradientOriginA ("Origin A", float) = 1
        _GradientOriginB ("Origin B", float) = 1
        
        _GradientCol1 ("Gradient Color 1", color) = (1.0, 1.0, 1.0, 1.0)
        _GradientCol2 ("Gradient Color 2", color) = (1.0, 1.0, 1.0, 1.0)
        _GradientCol3 ("Gradient Color 3", color) = (1.0, 1.0, 1.0, 1.0)
       
        [Header(Depth Distance)]
        [Space(10)]
        _DepthDistance("Depth Distance", float) = 1
        _DepthColor1 ("Depth Color 1", color) = (1.0, 1.0, 1.0, 1.0)
        _DepthColor2 ("Depth Color 2", color) = (1.0, 1.0, 1.0, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _GradientOriginA;
            float _GradientOriginB;
            float4 _GradientCol1;
            float4 _GradientCol2;
            float4 _GradientCol3;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float _gradientDist = i.worldPos.y * _GradientOriginA;

                

                float4 _gradient = lerp(_GradientCol1, _GradientCol2, _gradientDist);

                _gradient  = lerp(_GradientCol3, _gradient, i.worldPos.y * _GradientOriginB);
                ...
                //
                // return lerp(_baseCol, _DepthColor1, _depth);
